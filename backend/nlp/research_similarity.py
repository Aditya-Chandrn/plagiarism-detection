...
#     def __init__(self, tfidf_weight=0.3, transformer_weight=0.7):
...
#         try:
#             transformer_score = self.similarity_calculator.calculate_similarity(text1, text2)
...
#         if transformer_score == 0 and model_used != "Fallback to TF-IDF":
#             print(f"Transformer score is 0. Attempting to use the other transformer model.")
#             try:
#                 if model_used == "BERT":
#                     transformer_score = self.similarity_calculator.longformer_calculator.calculate_similarity(text1, text2)
#                     model_used = "Longformer (Fallback)"
#                 else:
#                     transformer_score = self.similarity_calculator.calculate_bert_similarity(text1, text2)
...
#         else:
#             combined_score = (self.tfidf_weight * tfidf_score) + (self.transformer_weight * transformer_score)
...
#     similarity_detector = ResearchPaperSimilarityDetector(tfidf_weight=0.3, transformer_weight=0.7)
